                            ...
                            <article class="staff-card">
                                ...
                                @if (auth()->user()->hasStaffRole(\App\Models\User::ROLE_PRODUCTION) && $job->assigned_user_id === auth()->id())
                                    @if ($job->status === 'READY_FOR_PRINT')
                                        <form method="POST" action="{{ route($operationRoutePrefix.'print-jobs.start', $job) }}" class="staff-workflow-form">@csrf<button type="submit" class="staff-button staff-button-primary">Start Production</button></form>
                                    ...
                                    @elseif ($job->status === 'PRINTING')
                                        ...
                                        <form method="POST" action="{{ route($operationRoutePrefix.'print-jobs.mark-printed', $job) }}" class="staff-workflow-form">@csrf<button type="submit" class="staff-button staff-button-primary">Mark Production Complete</button></form>
